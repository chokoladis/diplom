...
<head>
    ...
    <title>redmouse.ru/map.php</title>
    ...
    <section class="first" id="first">
        ...
        <div class="content">
            <div class="container">
                <div class="main">
                    <div class="item">
                        <li class="li_first"><a href="index.php" target="_blank" >Главная страница (логотип)</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
                                ...
                                <li><a href="auth.php">Авторизация</a></li>
                                <li><a href="sp_info.php">Справочная информация</a></li>
                                <li><a href="ask.php">Вопросы и ответы</a></li>
                                <li><a href="calendar.php">Календарь</a></li>
                                <li><a href="map.php">Карта сайта</a></li>
                            </ul>
                    </div>
                    <div class="item">
                        <li class="li_first"><a href="catalog.php" target="_blank" >Услуги</a></li>
                            <ul>
                    ...
                    <div class="item">
                    <li class="li_first"><a href="price.php" target="_blank" >Прайс - лист</a></li>
                        <ul>
                            <li><a href="index.php">Главная страница</a></li>
                            <li><a href="catalog.php">Услуги</a></li>
                            <li><a href="otz.php">Отзывы</a></li>
                    ...
                    <div class="item">
                        <li class="li_first"><a href="otz.php" target="_blank" >Отзывы</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
                    ...
                    <div class="item">
                        <li class="li_first"><a href="trek.php" target="_blank" >Трек-код</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
                                ...
                                <li><a href="auth.php">Авторизация</a></li>
                                <li><a href="add_change_trek.php">Добавить/изменить трек</a></li>
                                <li><a href="sp_info.php">Справочная информация</a></li>
                                <li><a href="ask.php">Вопросы и ответы</a></li>
                                <li><a href="calendar.php">Календарь</a></li>
                                <li><a href="map.php">Карта сайта</a></li>
                    ...
                    <div class="item">
                        <li class="li_first"><a href="about.php" target="_blank" >О нас</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
                    ...
                    <div class="item">
                        <li class="li_first"><a href="auth.php">Авторизация</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
                    ...
                    <div class="item">
                        <li class="li_first"><a href="registration.php">Регистрация</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
                    ...
                    <div class="item">
                        <li class="li_first"><a href="sp_info.php">Справочная информация</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
                    ...
                    <div class="item">
                        <li class="li_first"><a href="ask.php">Вопросы и ответы</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
                    ...
                    <div class="item">
                        <li class="li_first"><a href="calendar.php">Календарь</a></li>
                            <ul>
                                <li><a href="catalog.php">Услуги</a></li>
                                <li><a href="price.php">Прайс-лист</a></li>
                                <li><a href="otz.php">Отзывы</a></li>
